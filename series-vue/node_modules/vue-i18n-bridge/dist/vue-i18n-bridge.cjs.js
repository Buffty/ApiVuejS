...
function createComposer(options = {}, VueI18nLegacy) {
    ...
    // prettier-ignore
    const _datetimeFormats = vueDemi.ref(shared.isPlainObject(options.datetimeFormats)
            ? options.datetimeFormats
            : { [_locale.value]: {} })
        ;
    // prettier-ignore
    const _numberFormats = vueDemi.ref(shared.isPlainObject(options.numberFormats)
